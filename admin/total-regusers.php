...
?>
                  ...
                  <td><a href="total-regusers.php?del=<?php echo $row['id'];?>" onclick="return confirm('Do you really want to delete ?')>" style="color: #f05050"class='btn btn-danger'>Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
