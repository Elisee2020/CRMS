...
if(isset($_POST['resetUser']))
   ...
   if(isset($_POST['resetCompany']))
  {
    ...
    if($ret>0){
      $_SESSION['contactno']=$contactno;
      $_SESSION['email']=$email;
     header('location:../company/reset-password.php');
    }
    else{
      $msg="Invalid Details. Please try again.";
    }
...
<main>
 ...
 -->
                                <a onclick="showdd()" class="btn btn-success btn-lg btn-block" >Reset</a>


                                <div class="dropdowLogin " id="ddLogin">
                                    <input type="submit" name="resetUser" value="i'm a user">
                                    <input type="submit" name="resetCompany" value="we are a company">
                                    <!-- <input type="submit" name="resetAdmin" value="i'm an admins"> -->
                                </div>
